                        ...
                        <div class="col-lg-4 col-6 text-right">
                            <div class="btn-group">
                                @guest
                                    ...
                                    @endif
                                @else
                                    <button type="button" class="btn btn-sm text-primary dropdown-toggle" data-toggle="dropdown">{{ Auth::user()->name }}</button>
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <button class="dropdown-item" type="button"><a class="text-black" href="{{ url('my-orders') }}">My Order</a></button>
                                        <button class="dropdown-item" type="button"><a>My Profile</a></button>
